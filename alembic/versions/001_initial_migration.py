...
def upgrade() -> None:
    # Create users table with ENUM values (lowercase to match Python enum values)
    op.create_table(
        'users',
        ...
        sa.Column('role', mysql.ENUM('user', 'admin', name='userrole'), nullable=False, server_default='user'),
